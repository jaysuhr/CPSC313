...
public class ISA extends AbstractISA {
  ...
  InsLayout opCode, opCodeALU, opCodeShift, literal32, literal8, shiftField, shiftBits, register, offset4, offset8, offset8i, baseOffset4, 
  baseOffset8, baseOffset8i, index, absolute, pcRelative, null4, null8, null12; 
  
  public ISA () {
    super ("SM213", Endianness.BIG, new Assembler ()); 
