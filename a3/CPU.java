...
public class CPU extends AbstractY86CPU.Pipelined {
  ...
  @Override protected void pipelineHazardControl () throws Register.TimingException {
    ...
    // Had to create another bubble if Execute's iCd is a jump and Memory's iFn is a non-conditional
    else if ( (D.iCd.get()==I_JXX && E.iFn.get()!=C_NC) || (E.iCd.get()==I_JXX && M.iFn.get()!=C_NC)) {
      F.stall  = true;
      D.bubble = true;
    }
